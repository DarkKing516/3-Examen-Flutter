              ...
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(hintText: 'Fecha Publicación'),
                  ),
                  // const SizedBox(
                  //   height: 10,
                  // ),
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) => Card(
                ...
                child: ListTile(
                    ...
                    subtitle: Text('Decripción: ' + _journals[index]['description'] + '\nFecha Publicacion: '+ _journals[index]['fechaPublicacion'] + '\nPrecio: ' + _journals[index]['precio']),
                    trailing: SizedBox(
                      width: 100,
                      child: Row(
                        children: [
